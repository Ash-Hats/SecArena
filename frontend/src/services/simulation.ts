...
export const createPvpSession = (scenario_slug: string, team_choice: string, time_limit_minutes?: number) => apiRequest<SimulationSession>('/simulations/pvp/create', { method: 'POST', body: JSON.stringify({ scenario_slug, team_choice, time_limit_minutes }) });
